    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
                <a class="nav-link" @if($id_page == 1) style="font-weight: bold; color: orange;" @else style="color: orange" @endif>Boyzscoot</a>
              </li>
          <li class="nav-item">
          ...
          @if (auth()->user() == true)
            ...
            @else
            <li class="nav-item">
              <a class="nav-link" href="{{ route('my_cart') }}" @if($id_page == 8) style="font-weight: bold; color: orange;" @else style="color: #fff" @endif>Wishlist</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="{{ route('transaction_history') }}" @if($id_page == 7) style="color: orange;" @else style="color: #fff" @endif>Favorite Product</a>
            </li>
            @endif
          @endif
        </ul>
