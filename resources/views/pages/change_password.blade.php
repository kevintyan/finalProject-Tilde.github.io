            ...
            <div class="col-xl-9">
                <div class="card">
                    <form action="{{ url('/change_password_handle') }}" method="POST">
                        @csrf
                        <div class="card-body">
                            <h5 class="mb-4" style="color: orange; font-weight: bold">Change Password</h5>
                            <div class="mt-2">
                            ...
                            <button class="btn text-light mt-4" type="submit" style="background: orange">Update</button>
                          </div>
                    </form>
                </div>
            </div>
