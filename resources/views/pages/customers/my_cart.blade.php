    ...
    <div class="row p-3">
        ...
        <div class="row justify-content-center">
            <div class="col-xl-5">
                <div class="card">
                    <div class="card-body">
                    <p class="text-center mb-0">Your Wishlist is empty</p>
                    <p class="text-center"><a href="{{ route('show_product') }}">Let's check our Products</a></p>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="/checkout" method="POST">
                        ...
                        <div class="mt-3">
                            <button class="btn btn-warning">Add to Favorite ({{ $count_transaction }})</button>
                        </div>
                    </form>
                </div>
            </div>
