...
class CustomerController extends Controller
{
    public function add_cart_handle(Request $request)
    {
        ...
        return redirect()->route('my_cart')->with('success', 'Successfully added to Wishlist');
    }
    ...
    public function checkout(Request $request)
    {
        ...
        return redirect()->route('transaction_history')->with('success', 'Successfully added to Favorite!');
    }
